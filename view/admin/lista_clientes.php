...
?>
    ...
    <?php
       ...
       while ($row = mysql_fetch_array($res)) {
           ...
           echo '<td class="fright"><a href="?area=editar_cliente&idCliente='.$row['idCliente'].'" class="editar">Editar</a>  <a href="control/admin/excluir_cliente.php?idCliente='.$row['idCliente'].'" class="excluir">Excluir</a></td>';
           echo '</tr>';
           $cont = $cont + 1;
       }
    ?>
